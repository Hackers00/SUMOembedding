...
if __name__ == '__main__':
	...
	#Value data type to allow for cross thread information passing
	d = Value('d', 0.0)
	...
	#network parameters no longeer used
	...
	#once loop ends shut down thread and sumo simulaiton
